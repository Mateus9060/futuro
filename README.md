...
<head>
  ...
  <title>Colégio Futuro Elite</title>
  <link href="https://fonts.googleapis.com/css2?family=Orbitron&family=Poppins:wght@300;600&display=swap" rel="stylesheet">
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background: linear-gradient(180deg, var(--preto), #1a1a1a);
      color: var(--branco);
    }
...
<body>
  ...
  <section id="galeria" data-aos="fade-left">
    <h2>Galeria</h2>
    <div class="galeria">
